...
function bind(fn, ctx /* , arg1, arg2 */) {
  return (function (prependedArgs) {
      return function bound() {
          ...
          const args = prependedArgs.concat(Array.prototype.slice.call(arguments, 0));
 ...
 */
AFRAME.registerComponent('look-controls-v2', {
  ...
  */
  ...
  onTouchMove: function (evt) {
    ...
    yawObject.rotation.y -= (deltaY * direction) / 4;
    pitchObject.rotation.x -= (deltaX * direction) / 4;
